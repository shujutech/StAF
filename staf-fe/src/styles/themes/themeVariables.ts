...
import { lightColorsTheme } from './light/grayTheme';
...
const getThemeVariables = (theme: ThemeType) => css`
  ...
  --action-hyperlink-color: ${themeObject[theme].actionHyperlink};
  --btn-bg-color: ${themeObject[theme].btnBg};
  --btn-bg-hover-color: ${themeObject[theme].btnBgHover};
`;
